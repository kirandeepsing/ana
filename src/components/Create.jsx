...
const Create = () => {
  ...
  <Sidebar/>
     <form onSubmit={handleSubmit} className='h-[400px] w-[80%]  border-1 flex flex-col justify-center items-center space-y-3'>
      ...
      <input type="text" className='border-1 border-black h-10 rounded-lg px-3'
        name='title'
     ...
     {imagePreview && (
      ...
      <button type='submit' className='border-1 border-black rounded-lg h-12 w-32 bg-black text-white hover:bg-gray-800 cursor-pointer transition-transform'>Add Product</button>
    </form>
    </div>
    </>
  )
