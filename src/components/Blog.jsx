...
const Blog = () => {
    return (
        <>
            ...
            <div className='h-44 flex min-w-[400px] flex-wrap flex-col w-full justify-center items-center'>
            ...
            <div className='blog1 min-w-[400px] ml-3 sm:ml-0 relative text-white flex justify-center '>
                ...
                <div className='absolute ml-10 pr-10 top-54 left-0 w-96'>
                    <div className='flex space-x-4'>
                        <h2>News</h2> <span>Posted 3 Days Ago</span>
                    </div>
                    <h2 className='text-3xl mt-7'>Solutions for the big data issues, expert perspective</h2>
                    <p className='mt-8'>If there’s one way that wireless technology has changed the way we work, it’s that will everyone is now connected [...]
                    </p>
                </div>
            </div>
            ...
            <div className='popularpost h-[600px] flex flex-wrap'>
                <div>
                    {/*first div */}
                    <div className='h-[500px] cursor-pointer w-[400px] rounded-lg shadow-xl border-2 mt-15 ml-3 px-2 '>
            ...
            <div className='h-[840px] flex flex-wrap search'>
                ...
                <div className='w-96 h-[800px] ml-6 flex flex-col space-y-8  shadow-sm rounded-2xl'>
                    <h2>Search</h2>
                        ...
                        <div className='flex flex-wrap md:flex-nowrap cursor-pointer'>
                            ...
                            <div className='space-y-6 flex flex-wrap w-96 sm:w-96 md:flex-col  '>
                                ...
                                <div className=''>
                                    ...
                                    <p className='sm'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit aliquam amet nemo.</p>
                                </div>
            ...
            <div className='w-96 newsletter space-y-5 flex flex-col justify-center px-5 h-92 ml-5 border-1 rounded-2xl'>
                ...
                <button className='h-14 w-66 cursor-pointer hover:shadow-xl bg-blue-400 rounded-lg border-1'>
                    Subscribe
                </button>
            </div>
            {/* this is the 2nd of last section of the blog component */}
            <div className='w-96 h-20 mt-10 text-lg ml-5 font-bold'>
                <h2>Social</h2>
            ...
            <div className='w-96 h-52 mt-10 text-lg ml-5  font-bold'>
                <h2>Our Instagram</h2>
