...
const Hero2 = () => {
  return (
    <div className='bg-gray-300 w-full min-w-[400px] max-w-[2000px]  h-[600px] mt-32 sm:mt-0 flex flex-col justify-center gap-5 items-center'>
      ...
      >
        {images.map((img, index) => (
          <SwiperSlide key={index}>
            <div className='flex flex-wrap bg-white items-center border-2  overflow: hidden; height: max-content; w-full hover:translate-y-4 ransition-all duration-300 ease-in-out p-4 rounded-xl shadow-md'>
            <img
              src={img.img}
              alt={`slide-${index}`}
