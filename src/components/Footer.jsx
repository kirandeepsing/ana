...
const Footer = () => {
  return (
<>
<div className='h-auto md:h-[450px] min-w-[400px] ml-3  sm:h-auto md:w-[full] lg:w-full xl:w-full  sm:ml-0 text-2xl md:ml-0    flex flex-wrap items-center bg-gray-100'>
 ...
 <div className='h-32 md:w-full min-w-[400px] ml-3  flex-wrap lg:w-full xl:w-full  md:ml-0 bg-gray-100 flex items-center justify-center'>
